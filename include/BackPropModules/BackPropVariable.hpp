...
public:
  ...
  inline double getGradient() { return backwardValue; }
  ...
  BackPropVariable operator+(double rhs);
  BackPropVariable operator-(double rhs);
  BackPropVariable operator*(double rhs);
  BackPropVariable operator/(double rhs);

  void setBackPropValue(double value);
...
private:
  ...
  friend BackPropVariable tan(BackPropVariable &x);
  ...
  friend BackPropVariable operator+(double lhs, const BackPropVariable &rhs);
  friend BackPropVariable operator-(double lhs, const BackPropVariable &rhs);
  friend BackPropVariable operator*(double lhs, const BackPropVariable &rhs);
  friend BackPropVariable operator/(double lhs, const BackPropVariable &rhs);
};
...
extern BackPropVariable tan(BackPropVariable &x);
...
extern BackPropVariable operator+(double lhs, const BackPropVariable &rhs);
extern BackPropVariable operator-(double lhs, const BackPropVariable &rhs);
extern BackPropVariable operator*(double lhs, const BackPropVariable &rhs);
extern BackPropVariable operator/(double lhs, const BackPropVariable &rhs);
